use crate::app::{BrightnessArgs, OutputFormat};
use crate::output;
...
pub fn run(args: &BrightnessArgs, format: OutputFormat, dry_run: bool, show_schema: bool) -> i32 {
    if show_schema {
        let s = BrightnessOp::schema();
    ...
    let brightness_op = match BrightnessOp::new(value) {
        Ok(op) => op,
